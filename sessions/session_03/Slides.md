...
- 6/72 students are still ungrouped?

- Still one group without public repository in [`repositories.py`](https://github.com/itu-devops/MSc_lecture_notes/blob/master/repositories.py)? → Please fix that today!
...
* It seems to me that some of the groups are quite far with refactoring to other technologies.
* Others are slower?

* Reflection: Are you avoiding/using LLMS?
* Reflection: Are the LLMs helping?
